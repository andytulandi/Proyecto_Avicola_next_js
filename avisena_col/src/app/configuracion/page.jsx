...
const ConfiguracionGeneral = () => {
  ...
  useEffect(() => {
    ...
    setRememberSession(settings.rememberSession);
      ...
      <div className="max-w-[1240px] mx-auto px-4 md:px-6 lg:px-10 py-6 pb-24">
        ...
        <div className="space-y-6">
                ...
                {[
                  ...
                  <div key={toggle.label} className="flex items-center justify-between gap-4">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 ${toggle.checked ? 'bg-[#1B7A0A]' : 'bg-outline-variant'}`}
                    >
                      <span
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
            <button
              className="w-full rounded-2xl border-2 border-primary bg-transparent px-6 py-3 text-primary font-semibold transition hover:bg-primary hover:text-white"
              onClick={handleCancel}
            >
              Cancelar
            </button>
            <button
              className="w-full rounded-2xl bg-[#1B7A0A] px-6 py-3 text-white font-semibold transition hover:bg-[#0f4d06]"
              onClick={handleSave}
            >
              Guardar Cambios
            </button>
