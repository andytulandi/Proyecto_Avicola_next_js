export default function Header() {
    return (
        <header
            className="h-full flex items-center justify-between border-b border-solid border-[#eaf3e7] dark:border-emerald-900/30 px-3 py-2 sm:px-6 md:px-40 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md sticky top-0 z-50">
